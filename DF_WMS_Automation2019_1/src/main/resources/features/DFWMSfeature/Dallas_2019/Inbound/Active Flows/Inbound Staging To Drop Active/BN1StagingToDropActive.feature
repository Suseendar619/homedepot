@DFWMS
Feature: BN1StagingToDropActive
  
Scenario: Staging To Drop Active Flow BN1 Dallas
	Given Login as WMUser
	Then  Create PO xml "BNActiveDallas"
	Then  Get "ItemName" from xml "DallasZone"
	Then  Validate ItemZone in "Active" for "BN1"

@DFWMS
Feature: CFStagingToDropDallas
  
Scenario: Staging To Drop Reserve Flow CF1 Dallas
	Given Login as WMUser
	Then  Create PO xml "CF1ReserveDallas"
	Then  Get "ItemName" from xml "DallasZone"
	Then  Validate ItemZone in "Reserve" for "CF1"

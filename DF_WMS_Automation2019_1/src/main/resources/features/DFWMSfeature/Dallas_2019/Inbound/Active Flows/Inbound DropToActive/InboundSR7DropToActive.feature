@DFWMS
Feature: InboundSR7DropToActive
  
Scenario: Inbound SR7 Drop to Active flow Dallas
	Given Login as WMUser
	Then  Create PO xml "SR7InboundDallas"
	Then  Get "ItemName" from xml "DallasZone"
	Then  Validate ItemZone in "Active" for "SR7"

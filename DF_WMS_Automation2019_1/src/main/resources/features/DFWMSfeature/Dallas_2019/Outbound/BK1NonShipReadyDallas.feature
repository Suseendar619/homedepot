...
Feature: BK1NonShipReady
 ...
 Scenario: BK1 Non Ship Ready Dallas
	Given Login as WMUser
	Then Create DO xml "BK1NonShipReadyDallas"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BK1NonShipReadyDallas"
    ...
    Then Get details "ItemName" from xml for "BK1NonShipReadyDallas"

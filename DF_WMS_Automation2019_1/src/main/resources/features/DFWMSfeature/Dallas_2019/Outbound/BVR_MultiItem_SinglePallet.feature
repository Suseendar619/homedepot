...
Scenario: Outbound BVR Flow Dallas Multi Item Single Pallet
	Given Login as WMUser
	Then Create DO xml "BVR_Dallas_MISP"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BVR_Dallas_MISP"
    ...
    Then Get details "ItemName" from xml for "BVR_Dallas_MISP"
	...
	Then Generate Shipment for "BVR_Dallas"

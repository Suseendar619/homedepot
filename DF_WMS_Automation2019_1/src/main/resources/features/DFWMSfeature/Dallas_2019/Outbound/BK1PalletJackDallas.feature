@DFWMS
Feature: BK1PalletJack
  
Scenario: BK1 PalletJack Flow Dallas
	Given Login as WMUser
	Then Create DO xml "BK1PalletJackDallas"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BK1PalletJackDallas"
    ...
    Then Get details "ItemName" from xml for "BK1PalletJackDallas"
	...
	Then Generate Shipment for "MDO_Dallas"
	Then Open "Schedule Appointment" screen under "Distribution"
	Then Schedule Appointment "DallasZoneOutbound"
	Then Open "Check-In" screen under "Distribution"
	Then IB CheckIN "BK1PalletJack"

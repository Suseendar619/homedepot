...
Scenario: Hazmat Flow Dallas
	Given Login as WMUser
	Then Create DO xml "HazmatFlowDallas"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "HazmatFlowDallas"
    ...
    Then Get details "ItemName" from xml for "HazmatFlowDallas"

...
Scenario: LTL Outbound Flow Dallas
    Then Login as WMUser
    Then Create DO xml "LTLOutboundDallas"
    Then Open "Post Message" screen under "Integration"
    Then Post PO xml "LTLOutboundDallas"
    ...
    Then Get details "ItemName" from xml for "LTLOutboundDallas"
	...
	Then Schedule Appointment "LTLOutboundDallas"

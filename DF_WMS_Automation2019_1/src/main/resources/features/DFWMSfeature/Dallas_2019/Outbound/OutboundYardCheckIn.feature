...
Scenario: Outbound Yard CheckIn
	Given Login as WMUser
	Then Create DO xml "BVR_Dallas_Yard"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BVR_Dallas_Yard"
    ...
    Then Get details "ItemName" from xml for "BVR_Dallas_Yard"
	...
	Then Validate yard rules for "Outbound"

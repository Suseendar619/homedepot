...
Scenario: OB BVR Dallas Multi Shipment
	Given Login as WMUser
	Then Create DO xml "BVR_Dallas_OLPN_MS"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BVR_Dallas_OLPN_MS"
    ...
    Then Get details "ItemName" from xml for "BVR_Dallas_OLPN_MS"
	...
	Then Open "Shipments" screen under "Distribution"
	Then Generate Shipment for "Shipment_Multi"
	Then Open "Schedule Appointment" screen under "Distribution"
	Then Schedule Appointment "BVR_MSDallas"
	Then Open "Check-In" screen under "Distribution"
	Then IB CheckIN "BVR_MS"

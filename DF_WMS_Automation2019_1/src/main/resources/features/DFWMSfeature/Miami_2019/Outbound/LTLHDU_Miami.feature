...
Scenario: Outbound LTL HDU Flow Miami
	Then Login as WMUser
    Then Create DO xml "LTL_HDU_Miami"
    Then Open "Post Message" screen under "Integration"
    Then Post PO xml "LTL_HDU_Miami"
    ...
    Then Get details "ItemName" from xml for "LTL_HDU_Miami"

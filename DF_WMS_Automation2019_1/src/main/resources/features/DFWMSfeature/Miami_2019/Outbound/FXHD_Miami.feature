...
Scenario: Outbound FXHD Flow Miami
	Given Login as WMUser
	Then Create DO xml "FXHD_Miami"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "FXHD_Miami"    
    ...
    Then Get details "ItemName" from xml for "FXHD_Miami"
    ...
    Then Open "EPI Transaction Log" screen under "Distribution"
    Then Input and Apply WaveNumber for "FXHD_Tracey" 
    Then Validate EPI status for "FXHD_Miami"

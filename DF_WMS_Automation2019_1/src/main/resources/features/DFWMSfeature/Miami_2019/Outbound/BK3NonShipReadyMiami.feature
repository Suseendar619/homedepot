...
Scenario: BK3 Non Ship Ready Miami
	Given Login as WMUser
	Then Create DO xml "BK3NonShipReadyMiami"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BK3NonShipReadyMiami"
    ...
    Then Get details "ItemName" from xml for "BK3NonShipReadyMiami"

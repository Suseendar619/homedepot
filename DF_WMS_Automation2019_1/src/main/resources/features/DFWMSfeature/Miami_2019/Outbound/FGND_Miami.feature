...
Scenario: Outbound FGND Flow Miami 
	Given Login as WMUser
	Then Create DO xml "FGND_Miami"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "FGND_Miami"   
    Then Validate status for "Distribution Orders" - "Released"
    Then Open "Run Waves" screen under "Distribution"    
    Then Select Wave "Automation - BK1 - Non Ship Ready" and Run
    Then Select "Bulk Non Ship Ready" Define and Submit for "FGND_Miami"
    ...
    Then Input and Apply WaveNumber for "FGND_Miami"
    ##Then Validate EPI status for "FGND_Miami"
    Then Get details "ItemName" from xml for "FGND_Miami"

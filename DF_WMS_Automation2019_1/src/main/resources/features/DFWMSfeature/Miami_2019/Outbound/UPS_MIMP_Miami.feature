...
Scenario: Outbound UPS Miami MultiItem MultiPallet
	Given Login as WMUser
	Then Create DO xml "UPS_Miami_MISP"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "UPS_Miami_MISP"  
    ...
    Then Get details "ItemName" from xml for "UPS_Miami_MISP"

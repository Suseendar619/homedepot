@DFWMS
Feature: VerifyIBShipmentsGreaterThan100Lpns_Miami

  Scenario: Verify_IB_Shipments GreaterThan100Lpns Miami
    Given Login as WMUser
    Then  Create PO xml "VerifyIBShipment2019_Miami"
    Then  Open "Post Message" screen under "Integration"
    Then  Post PO xml "VerifyIBShipment2019_Miami"
    ...
    Then  IB CheckIN "HoustonZone"
 	Then  Get "ItemName" from xml "VerifyIBShipment2019_Miami"

@DFWMS
Feature: Mod 10 Flow Tampa 
  
Scenario: Inbound Mod10 Flow Tampa
	Given Login as WMUser
	Then  Create PO xml "MOD10_Tampa"
	Then  Open "Post Message" screen under "Integration"
	Then  Post PO xml "MOD10_Tampa"
	...
	Then  Get "ItemName" from xml "MOD10_Tampa"

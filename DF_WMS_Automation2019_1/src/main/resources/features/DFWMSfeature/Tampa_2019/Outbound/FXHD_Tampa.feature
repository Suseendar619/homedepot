...
Scenario: Outbound FXHD Flow Tampa
	Given Login as WMUser
	Then Create DO xml "FXHD_Tampa"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "FXHD_Tampa"    
    ...
    Then Get details "ItemName" from xml for "FXHD_Tampa"

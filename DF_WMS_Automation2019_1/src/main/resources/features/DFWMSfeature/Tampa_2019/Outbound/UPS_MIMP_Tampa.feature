...
Scenario: Outbound UPS Tampa MultiItem MultiPallet
	Given Login as WMUser
	Then Create DO xml "UPS_Tampa_MISP"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "UPS_Tampa_MISP"  
    ...
    Then Get details "ItemName" from xml for "UPS_Tampa_MISP"

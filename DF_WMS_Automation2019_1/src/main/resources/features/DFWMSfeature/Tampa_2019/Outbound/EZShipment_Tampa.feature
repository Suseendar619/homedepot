...
Scenario: EZ Shipment Flow Tampa 
	Given Login as WMUser
	Then Create DO xml "EZShipment_Tampa"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "EZShipment_Tampa"
    ...
    Then Get details "ItemName" from xml for "EZShipment_Tampa"

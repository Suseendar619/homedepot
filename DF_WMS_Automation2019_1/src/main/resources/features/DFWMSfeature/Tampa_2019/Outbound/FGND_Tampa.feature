...
Scenario: Outbound FGND Flow Tampa 
	Given Login as WMUser
	Then Create DO xml "FGND_Tampa"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "FGND_Tampa"   
    ...
    Then Get details "ItemName" from xml for "FGND_Tampa"

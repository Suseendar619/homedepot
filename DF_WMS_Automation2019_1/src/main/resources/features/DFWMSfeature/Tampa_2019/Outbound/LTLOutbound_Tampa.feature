...
Scenario: LTL Outbound Flow Tampa
    Then Login as WMUser
    Then Create DO xml "LTLOutboundTampa"
    Then Open "Post Message" screen under "Integration"
    Then Post PO xml "LTLOutboundTampa"
    ...
    Then Get details "ItemName" from xml for "LTLOutboundTampa"

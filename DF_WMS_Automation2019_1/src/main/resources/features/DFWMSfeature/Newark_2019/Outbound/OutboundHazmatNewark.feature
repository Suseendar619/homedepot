...
Scenario: Hazmat Flow Newark
	Given Login as WMUser
	Then Create DO xml "HazmatFlowNewark"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "HazmatFlowNewark"
    ...
    Then Get details "ItemName" from xml for "HazmatFlowNewark"

...
Scenario: Outbound FGND Flow Newark
	Given Login as WMUser
	Then Create DO xml "FGND_Newark"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "FGND_Newark"   
    ...
    Then Get details "ItemName" from xml for "FGND_Newark"

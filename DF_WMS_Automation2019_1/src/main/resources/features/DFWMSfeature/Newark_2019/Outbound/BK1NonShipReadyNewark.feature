...
Scenario: BK1 Non Ship Ready Newark
	Given Login as WMUser
	Then Create DO xml "BK1NonShipReadyNewark"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BK1NonShipReadyNewark"
    ...
    Then Get details "ItemName" from xml for "BK1NonShipReadyNewark"

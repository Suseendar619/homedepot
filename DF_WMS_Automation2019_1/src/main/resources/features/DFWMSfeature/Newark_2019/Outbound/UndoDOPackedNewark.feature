@DFWMS
Feature: UndoDOPackedNewark
  
Scenario: OB Undo DO in Packed state Newark
	Given Login as WMUser
	Then Create DO xml "BK1NSRNewark_UndoDO_IP"
	Then Create DO xml "BVR_Newark_UndoDO_Packed"
    ...
    Then Get details "ItemName" from xml for "BVR_Newark_UndoDO"

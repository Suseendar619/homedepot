@DFWMS
Feature: VerifyIBShipmentsGreaterThan100Lpns_Newark2019

Scenario: Verify_IB_Shipments GreaterThan100Lpns 2019 Newark
    Given Login as WMUser
    Then  Create PO xml "VerifyIBShipment2019"
    Then  Open "Post Message" screen under "Integration"
    Then  Post PO xml "VerifyIBShipment2019"
    ...
    Then  IB CheckIN "HoustonZone"
 	Then  Get "ItemName" from xml "VerifyIBShipment2019"

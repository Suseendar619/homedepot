...
Scenario: BK3 Non Ship Ready Tracey
	Given Login as WMUser
	Then Create DO xml "BK3NonShipReadyTracey"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BK3NonShipReadyTracey"
    ...
    Then Get details "ItemName" from xml for "BK3NonShipReadyTracey"
	...
	Then Generate Shipment for "MDO_Tracey"

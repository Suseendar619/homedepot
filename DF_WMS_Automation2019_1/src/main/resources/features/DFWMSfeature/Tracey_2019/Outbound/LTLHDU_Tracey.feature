...
Scenario: Outbound LTL HDU Flow Tracey
	Then Login as WMUser
    Then Create DO xml "LTL_HDU_Tracey"
    Then Open "Post Message" screen under "Integration"
    Then Post PO xml "LTL_HDU_Tracey"
    ...
    Then Get details "ItemName" from xml for "LTL_HDU_Tracey"

...
Scenario: Outbound FXHD Flow Tracey
	Given Login as WMUser
	Then Create DO xml "FXHD_Tracey"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "FXHD_Tracey"    
    ...
    Then Get details "ItemName" from xml for "FXHD_Tracey"

...
Scenario: Outbound UPS Tracey MultiItem MultiPallet
	Given Login as WMUser
	Then Create DO xml "UPS_Tracey_MISP"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "UPS_Tracey_MISP"  
    ...
    Then Get details "ItemName" from xml for "UPS_Tracey_MISP"

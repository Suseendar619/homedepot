...
Scenario: EZ Shipment Flow Tracey 
	Given Login as WMUser
	Then Create DO xml "EZShipment_Tracey"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "EZShipment_Tracey"
    ...
    Then Get details "ItemName" from xml for "EZShipment_Tracey"

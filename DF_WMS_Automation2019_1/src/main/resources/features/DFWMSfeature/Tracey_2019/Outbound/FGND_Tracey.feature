...
Scenario: Outbound FGND Flow Tracey 
	Given Login as WMUser
	Then Create DO xml "FGND_Tracey"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "FGND_Tracey"   
    ...
    Then Get details "ItemName" from xml for "FGND_Tracey"

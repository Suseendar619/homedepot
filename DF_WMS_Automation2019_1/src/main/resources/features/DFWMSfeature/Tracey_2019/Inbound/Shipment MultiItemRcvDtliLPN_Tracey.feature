@DFWMS
Feature: Shipment MultiItemRcvDtliLPN_Tracey

  Scenario: Shipment MultiItem Rcv Dtl iLPN flow Tracey
    Given Login as WMUser
    Then  Create PO xml "ShipmentRcvDtlTampa"
    Then  Open "Post Message" screen under "Integration"
    Then  Post PO xml "ShipmentRcvDtlTampa"
    ...
    Then  IB CheckIN "HoustonZone"
 	Then  Get "ItemName" from xml "ShipmentRcvDtlTampa"

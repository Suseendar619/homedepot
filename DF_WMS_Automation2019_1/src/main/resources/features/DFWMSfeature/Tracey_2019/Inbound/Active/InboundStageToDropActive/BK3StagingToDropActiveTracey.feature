@DFWMS
Feature: BK3StagingToDropActiveTracey
  
Scenario: Staging To Drop Active Flow BK3 Tracey
	Given Login as WMUser
	Then  Create PO xml "BK3ActiveTracey"
	Then  Get "ItemName" from xml "Zone"
	Then  Validate ItemZone in "Active" for "BK3"

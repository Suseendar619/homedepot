@DFWMS
Feature: HazmatStagingToDropActiveBaltimore
  
Scenario: Staging To Drop Active Flow Hazmat
	Given Login as WMUser
	Then  Create PO xml "HazmatActivebaltimore"
	Then  Get "ItemName" from xml "Zone"
	Then  Validate ItemZone in "Active" for "HZ1"

@DFWMS
Feature: CPStagingToDropActiveBaltimore
  
Scenario: Staging To Drop Active Flow CP Baltimore
	Given Login as WMUser
	Then  Create PO xml "CP1ActiveBaltimore"
	Then  Get "ItemName" from xml "Zone"
	Then  Validate ItemZone in "Active" for "CP1"

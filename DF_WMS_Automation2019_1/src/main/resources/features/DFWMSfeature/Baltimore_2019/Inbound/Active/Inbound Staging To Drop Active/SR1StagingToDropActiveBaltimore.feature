...
Feature: SR1StagingToDropActiveBaltimore
  
Scenario: Staging To Drop Active Flow SR1 Baltimore
	Given Login as WMUser
	Then  Create PO xml "SR1ActiveBaltimore"
	Then  Get "ItemName" from xml "Zone"
	Then  Validate ItemZone in "Active" for "SR1"

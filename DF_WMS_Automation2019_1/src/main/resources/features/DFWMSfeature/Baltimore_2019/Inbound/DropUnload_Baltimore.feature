@DFWMS
Feature: DropUnload_Baltimore
  
Scenario: BK1STDActiveDropUnload Flow Baltimore
	Given Login as WMUser
	Then  Create PO xml "BK1ActiveBaltimore"
	...
	Then  Inbound Receive in Putty "Zone"
	Then Validate status for "ASN" - "Receiving Started"
	Then  Validate iLPN's
	Then  Inbound Putaway in Putty "STDZoneActive"

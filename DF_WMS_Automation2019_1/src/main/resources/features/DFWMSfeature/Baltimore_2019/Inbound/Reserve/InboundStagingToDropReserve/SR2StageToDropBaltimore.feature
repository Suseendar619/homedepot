@DFWMS
Feature: SR2StagingToDrop
  
Scenario: Staging To Drop Reserve Flow SR2 Baltimore
	Given Login as WMUser
	Then  Create PO xml "SR2ReserveBaltimore"
	...
	Then  Inbound Putaway in Putty "STDZoneReserve"

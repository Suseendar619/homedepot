...
Scenario: EZ Shipment Flow Baltimore 
	Given Login as WMUser
	Then Create DO xml "EZShipment_Baltimore"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "EZShipment_Baltimore"
    ...
    Then Get details "ItemName" from xml for "EZShipment_Baltimore"
    ...
    Then AnchorInPutty for "EZShipment_Baltimore"

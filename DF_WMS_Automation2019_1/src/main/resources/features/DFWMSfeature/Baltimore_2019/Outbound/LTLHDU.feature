...
Scenario: Outbound LTL HDU Flow Baltimore
	Then Login as WMUser
    Then Create DO xml "LTL_HDU_Baltimore"
    Then Open "Post Message" screen under "Integration"
    Then Post PO xml "LTL_HDU_Baltimore"
    ...
    Then Get details "ItemName" from xml for "LTL_HDU_Baltimore"

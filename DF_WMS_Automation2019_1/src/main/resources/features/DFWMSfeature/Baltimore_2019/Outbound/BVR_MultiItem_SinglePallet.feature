...
Scenario: Outbound BVR Flow Baltimore Multi Item Single Pallet
	Given Login as WMUser
	Then Create DO xml "BVR_Baltimore_MISP"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BVR_Baltimore_MISP"
    ...
    Then Get details "ItemName" from xml for "BVR_Baltimore_MISP"
    Then Outbound PickToLabel in Putty for "BVR_Baltimore_MISP"
	...
	Then Generate Shipment for "BVR_Baltimore"
	Then Open "Schedule Appointment" screen under "Distribution"
	Then Schedule Appointment "BaltimoreZoneOutbound"
	Then Open "Check-In" screen under "Distribution"
	Then IB CheckIN "BVR_Baltimore_MISP"
	Then Outbound LoadTrailer in Putty for "BVR_Baltimore_MISP"

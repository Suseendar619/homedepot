...
Scenario: Outbound HDU TL Flow Baltimore
	Given Login as WMUser
	Then Create DO xml "HDUTL_Baltimore"
    Then Open "Post Message" screen under "Integration"
    Then Post PO xml "HDUTL_Baltimore"
	...
	Then Get details "ItemName" from xml for "HDUTL_Baltimore"

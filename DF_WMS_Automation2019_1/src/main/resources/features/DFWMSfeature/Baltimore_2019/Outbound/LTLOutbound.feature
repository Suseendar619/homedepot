...
Scenario: LTL Outbound Flow Baltimore
    Then Login as WMUser
    Then Create DO xml "LTLOutboundBaltimore"
    Then Open "Post Message" screen under "Integration"
    Then Post PO xml "LTLOutboundBaltimore"
    ...
    Then Get details "ItemName" from xml for "LTLOutboundBaltimore"

@DFWMS
Feature: SR2StagingToDropActiveAtlanta
  
Scenario: Staging To Drop Active Flow SR2 Atlanta
	Given Login as WMUser
	Then  Create PO xml "SR2ActiveAtlanta"
	Then  Get "ItemName" from xml "Zone"
	##Then  Validate ItemZone in "Active" for "SR2"

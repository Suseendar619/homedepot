@DFWMS
Feature: Mod 10 Flow Atlanta 
  ##only reserve zone sku
  
Scenario: Inbound Mod10 Flow Atlanta
	Given Login as WMUser
	Then  Create PO xml "MOD10_Atlanta"
	Then  Open "Post Message" screen under "Integration"
	Then  Post PO xml "MOD10_Atlanta"
	...
	Then  Get "ItemName" from xml "MOD10_Atlanta"

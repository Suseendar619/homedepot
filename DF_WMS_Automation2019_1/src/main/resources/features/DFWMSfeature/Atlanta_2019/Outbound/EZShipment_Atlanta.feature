...
Scenario: EZ Shipment Flow Atlanta 
	Given Login as WMUser
	Then Create DO xml "EZShipment_Atlanta"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "EZShipment_Atlanta"
    ...
    Then Get details "ItemName" from xml for "EZShipment_Atlanta"

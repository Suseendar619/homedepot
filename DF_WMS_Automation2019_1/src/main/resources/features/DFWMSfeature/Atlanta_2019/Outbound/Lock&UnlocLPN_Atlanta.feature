...
Scenario: Lock and Unlock LPN Atlanta
	Given Login as WMUser
	Then Create DO xml "BK1NonShipReadyAtlanta"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BK1NonShipReadyAtlanta"
    ...
    Then Get details "ItemName" from xml for "BK1NonShipReadyAtlanta"
    Then Open "oLPNs" screen under "Distribution"
    Then Input oLPNs and Apply for "BK1NonShipReadyAtlanta"
    Then Lock LPN
	...
	Then Generate Shipment for "MDO_Atlanta"
	Then Open "Schedule Appointment" screen under "Distribution"
	Then Schedule Appointment "DallasZoneOutbound"
	Then Open "Check-In" screen under "Distribution"
	Then IB CheckIN "BK1NonShipReadyAtlanta"

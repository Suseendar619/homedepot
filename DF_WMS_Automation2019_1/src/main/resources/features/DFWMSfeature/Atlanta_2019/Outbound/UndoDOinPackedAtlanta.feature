...
Scenario: OB Undo DO in Packed state Atlanta
	Given Login as WMUser
	Then Create DO xml "LTLOutboundAtlanta_UndoDO"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "LTLOutboundAtlanta_UndoDO"
    ...
    Then Get details "ItemName" from xml for "LTLOutboundAtlanta_UndoDO"

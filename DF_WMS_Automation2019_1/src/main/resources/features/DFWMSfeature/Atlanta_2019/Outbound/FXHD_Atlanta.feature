...
Scenario: Outbound FXHD Flow Atlanta
	Given Login as WMUser
	Then Create DO xml "FXHD_Atlanta"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "FXHD_Atlanta"    
    ...
    Then Get details "ItemName" from xml for "FXHD_Atlanta"
    ...
    Then Input and Apply WaveNumber for "FXHD_Atlanta" 

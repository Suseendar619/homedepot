@DFWMS
Feature: VerifyIBShipmentsGreaterThan100Lpns_Lacey

  Scenario: Verify_IB_Shipments GreaterThan100Lpns 2019 Lacey
    Given Login as WMUser
    Then  Create PO xml "VerifyIBShipment2019_Lacey"
    Then  Open "Post Message" screen under "Integration"
    Then  Post PO xml "VerifyIBShipment2019_Lacey"
    ...
    Then  IB CheckIN "HoustonZone"
 	Then  Get "ItemName" from xml "VerifyIBShipment2019_Lacey"

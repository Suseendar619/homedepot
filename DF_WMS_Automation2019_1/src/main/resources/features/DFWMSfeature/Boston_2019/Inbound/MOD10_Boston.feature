@DFWMS
Feature: MOD10_Boston
  
Scenario: MOD10 Inbound flow Boston
	Given Login as WMUser
	Then  Create PO xml "MOD10_Boston"
	Then  Open "Post Message" screen under "Integration"
	Then  Post PO xml "MOD10_Boston"
	...
	Then  Get "ItemName" from xml "MOD10_Boston"

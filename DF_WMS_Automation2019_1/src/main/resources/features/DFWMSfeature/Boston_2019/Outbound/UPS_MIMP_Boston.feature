...
Scenario: Outbound UPS Boston MultiItem MultiPallet
	Given Login as WMUser
	Then Create DO xml "UPS_Boston_MISP"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "UPS_Boston_MISP"  
    ...
    Then Get details "ItemName" from xml for "UPS_Boston_MISP"

...
Scenario: EZ Shipment Flow Boston 
	Given Login as WMUser
	Then Create DO xml "EZShipment_Boston"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "EZShipment_Boston"
    ...
    Then Get details "ItemName" from xml for "EZShipment_Boston"

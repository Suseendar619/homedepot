...
Scenario: Outbound FXHD Flow Boston
	Given Login as WMUser
	Then Create DO xml "FXHD_Boston"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "FXHD_Boston"    
    Then Validate status for "Distribution Orders" - "Released"
    Then Open "Run Waves" screen under "Distribution"    
    Then Select Wave "Automation - BK1 - Non Ship Ready" and Run
    Then Select "Bulk Non Ship Ready" Define and Submit for "FXHD_Tampa"
    ...
    Then Input and Apply WaveNumber for "FXHD_Tracey"
    Then Get details "ItemName" from xml for "FXHD_Boston"
    ...
    Then Open "EPI Transaction Log" screen under "Distribution"
    Then Input and Apply WaveNumber for "FXHD_Tracey" 
    Then Validate EPI status for "FXHD_Boston"

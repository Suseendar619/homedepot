...
Scenario: BK3 Non Ship Ready Boston
	Given Login as WMUser
	Then Create DO xml "BK3NonShipReadyBoston"
	Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BK3NonShipReadyBoston"
    ...
    Then Get details "ItemName" from xml for "BK3NonShipReadyBoston"

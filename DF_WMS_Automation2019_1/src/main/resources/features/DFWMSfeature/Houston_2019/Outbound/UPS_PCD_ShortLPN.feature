...
Scenario: Outbound UPS Flow Short LPN Pack Cube Dir Houston
    ...
    Then Select "Bulk Non Ship Ready" Define and Submit for "UPS_Houston_MISP"
    Then Open "Waves" screen under "Distribution"
    Then Input WaveNumber and Apply 
    Then Validate Wave Completion    
    Then Validate status for "oLPNs" - "Printed"
   ## Then Validate status for LM "Shipvia"
    Then Get details "ItemName" from xml for "UPS_Houston_MISP"
    Then Outbound PickToLabel in Putty for "ShortLPNHouston"

...
Scenario: OB MDO Houston MultiShipment
	Given Login as WMUser
	Then Create DO xml "BK1NonShipReady_MultiShipment"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BK1NonShipReady_MultiShipment"
    ...
    Then Get details "ItemName" from xml for "BK1NonShipReady_MultiShipment"

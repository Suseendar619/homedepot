...
Scenario: Outbound LTL HDU Flow Houston
	Then Login as WMUser
    Then Create DO xml "LTL HDU Houston"
    Then Open "Post Message" screen under "Integration"
    Then Post PO xml "LTL HDU Houston"
    ...
    Then Get details "ItemName" from xml for "LTL HDU Houston"
	...
	Then Generate Shipment for "LTL_HDU_Houston"

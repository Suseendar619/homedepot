...
Scenario: OB BVR Houston Multi Stop
	Given Login as WMUser
	Then Create DO xml "BVR_MutliStop_Houston"
	Then Create DO xml "BVR_Houston_MutliStop"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BVR_MutliStop_Houston"
	Then Post PO xml "BVR_Houston_MutliStop"
    ...
    Then Get details "ItemName" from xml for "BVR_MutliStop_Houston"

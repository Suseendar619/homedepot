@DFWMS
Feature: MDO_Multi_Stop
  
Scenario: OB MDO Dallas Multi Stop
	Given Login as WMUser
	Then Create DO xml "MDO_MutliStop"
	Then Create DO xml "MDO_Dallas_MutliStop"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "MDO_MutliStop"
	Then Post PO xml "MDO_Dallas_MutliStop"
    ...
    Then Get details "ItemName" from xml for "MDO_MutliStop"
    Then Get details "ItemName" from xml for "MDO_Dallas_MutliStop"

...
Scenario: OB BVR Houston Split Shipment
	Given Login as WMUser
	Then Create DO xml "BVR_Houston_SplitShipment1"
	Then Create DO xml "BVR_Houston_SplitShipment2"
    Then Open "Post Message" screen under "Integration"
	Then Post PO xml "BVR_Houston_SplitShipment1"
	Then Post PO xml "BVR_Houston_SplitShipment2"
    ...
    Then Get details "ItemName" from xml for "BVR_Houston_SplitShipment1"
    Then Get details "ItemName" from xml for "BVR_Houston_SplitShipment2"
    Then Outbound PickToLabel in Putty for "Split_Shipment"

...
Scenario: Outbound UPS Fluid Load Flow Houston Insert Pallet
    ...
    Then PalletizeOlpnParcel fluid for "MultiItemMultiPallet"
	Then Open "Schedule Appointment" screen under "Distribution"
	Then Schedule Appointment "UPS_Houston"
	Then Open "Check-In" screen under "Distribution"
	Then IB CheckIN "UPS_Houston"
	Then  Insert Pallet into Divert history table "Pallet" - "Printed"
	Then Outbound PCLFluidLoad in Putty for "UPS_Houston_Pallet"

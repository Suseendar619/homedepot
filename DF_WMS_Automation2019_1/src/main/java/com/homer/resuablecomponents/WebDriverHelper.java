...
//			wait.until(ExpectedConditions.visibilityOfElementLocated(elementBy));
	 ...
	 * @throws InterruptedException 
	 */
	public void clearElement(By elementBy) throws InterruptedException {
...
//			wait.until(expectation);
	 ...
	 * @throws Exception
	 */
	public WebElement getElement(By elementBy) throws Exception {
		WebElement el = null;
		if (isElementPresent(elementBy,2)){
			el = driver.findElement(elementBy);
		}
		return el;
	}
	...
	public void contextClic(By shipmentbody) throws Exception{	
		WebElement element=driver.findElement(shipmentbody);
		Actions action = new Actions(driver).contextClick(element);
		action.build().perform();
	}
	
	public void sendKeydateVal(By elementBy) {
...
try {
	...
	public void selectText(By elementBy, String label) {
		// TODO Auto-generated method stub
		new Select(driver.findElement(elementBy)).selectByVisibleText(label);;
	}

	public void selectText(By elementBy) {
		// TODO Auto-generated method stub
		new Select(driver.findElement(elementBy));
	}
